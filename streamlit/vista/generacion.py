...
def main(selected_time):
    ...
    fig =px.line(data_frame = filtered_generacion_data, x = 'Fecha actualización', y = 'Valores', color = 'nombre',
    ...
    fig2 = px.histogram(data_frame= filtered_generacion_data,
             x = 'Valores',
             y = 'Porcentaje',
    ...
    fig3 = px.box(data_frame = filtered_generacion_data,
       x = 'Valores',
       y = 'nombre',
       color= 'nombre')
    st.plotly_chart(fig3,use_container_width=True)

    fig4 = px.box(data_frame = filtered_generacion_data,
        x = 'Valores',
        y =  'tipo de energía',
